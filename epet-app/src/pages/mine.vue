    ...
    <div class="loagin">
      ...
      <div class="main">
        ...
        <div class="other_login">
          <div class="ZFB">
            <a href="#">
              <img src="../common/img/login_ico2.png" alt="">
            </a>
          </div>
          <div class="QQ">
            <a href="#">
              <img src="../common/img/login_ico4.png" alt="">
            </a>
          </div>
        </div>
      </div>
...
.loagin
  .header
    width 100%
    background url("../common/img/logobg.png") no-repeat
    ...
    .header-top
      ...
      .arrow
        ...
        position: absolute;
        margin-top: 16px;
        background: url('../common/img/personal-bico3.png') no-repeat;
      ...
      #login_form
        ...
        ul
          li
            ...
            .nameico
              height: 21px;
              background: url('../common/img/ico3.png') no-repeat;
              background-size: contain;
              margin: 1px 0 0 -25px;
            .passwordico
              height: 20px
              margin: 0px 0 0 -25px;
              background: url('../common/img/ico4.png') no-repeat;
              background-size: contain;
            input
              display: block;
              height: 21px;
        ...
        ul
          ...
          li
            ...
            .numico
              ...
              width: 17px;
              height: 17px;
              background: url('../common/img/ico1.png') no-repeat;
              background-size: contain;
              margin: 1px 0 0 -25px;
            .passwordico
              float: left;
